...
hl.bind("SUPER + J", hl.dsp.focus({ direction = "down" }), { description = "Focus down / cycle group down" })
hl.bind("SUPER + L", hl.dsp.focus({ direction = "right" }), { description = "Focus right / cycle group right" })
hl.bind("SUPER + K", hl.dsp.focus({ direction = "up" }), { description = "Focus up / cycle group up" })
hl.bind("SUPER + LEFT", hl.dsp.focus({ direction = "left" }), { description = "Focus left / cycle group left" })
hl.bind("SUPER + DOWN", hl.dsp.focus({ direction = "down" }), { description = "Focus down / cycle group down" })
hl.bind("SUPER + RIGHT", hl.dsp.focus({ direction = "right" }), { description = "Focus right / cycle group right" })
hl.bind("SUPER + UP", hl.dsp.focus({ direction = "up" }), { description = "Focus up / cycle group up" })
